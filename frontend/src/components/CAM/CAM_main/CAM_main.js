...
function CAM_main() {
  return (
    ...
    <p class="card-text">Consultancy Support within 24 hours just to make
    sure to our valuble customers that we are within the range of
    finger tip.</p>
  </div>
</div>
</Col>
<Col>
    ...
    <p class="card-text">Always reviewing what our customers thoughts
    on us and continousely growing up to be the best version in the 
    industry.
    </p>
  </div>
</div>
...
<Col>
    ...
    <p class="card-text">Collection of  valuable advices we have 
    given to our customers ; so others won't have to ask!!</p>
  </div>
</div>
</Col>
</Row>
