...
function Feedback() {
  ...
  function sendFeedback(e){
    ...
    axios.post("http://localhost:5000/CAM/add-feedback",newFeedback).then(() =>{
  ...
  return(
      <Form className="form" noValidate validated={validated} onSubmit={sendFeedback}>
      <h3>FeedBack</h3>
      <p className="para1">At Neo Tech we value your feedback.
